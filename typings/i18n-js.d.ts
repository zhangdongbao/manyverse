...
declare module 'i18n-js' {
  type Key =
    ...
    | 'notifications.syncing.title'
    | 'notifications.syncing.gigabytes'
    | 'notifications.syncing.megabytes'
    | 'notifications.syncing.kilobytes'
    | 'notifications.syncing.bytes'
    ...
    | 'message.call_to_action.read_more'
